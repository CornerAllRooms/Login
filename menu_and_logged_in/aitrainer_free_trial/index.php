...
<body>
    <!-- User info bar -->
    <div class="user-bar">
        <div class="user-email">Are you ready <?php echo htmlspecialchars($fname); ?>!</div>
        <a href="cornerroom.co.za" class="logout-link">Home</a>
    </div>
    ...
    <script>
        ...
        continueBtn.addEventListener('click', function() {
            ...
            const fields = {
                cmd: '_paynow',
                receiver: '23908197',
                return_url: 'https://cornerroom.co.za/AITrainer/brBFoydeF',
